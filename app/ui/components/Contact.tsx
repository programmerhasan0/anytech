...
const Contact: React.FC = () => {
    return (
        <section className="bg-[radial-gradient(24.45%_88.58%_at_23.57%_2%,_#00e9ea_0%,_#1f80f0_52.08%,_#005bc4_100%)] px-5 py-40 text-white clip-triangle-footer md:clip-triangle-footer-md">
